...
function ForFondants() {
  return (
    <Section>
      ...
      />
      <ContentDiv>
        <Card src={ModelingPensSet1} classTitle="Modeling Pens Set 1" Description=" Stainless steel " Set=" 4" price="40"/>
        <Card src={ModelingPensSet2} classTitle="Modeling Pens Set 2" Description="Small stainless steel ball and rubber headed pens" Set=" 5" price="25"/>
        <Card src={ModelingPensSet3} classTitle="Modeling Pens Set 3" Description="Wood random shapes modeling pen" Set=" 4" price="36"/>
      </ContentDiv>
    </Section>
  );
}
